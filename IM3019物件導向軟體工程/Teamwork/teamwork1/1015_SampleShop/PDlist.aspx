<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PDlist.aspx.vb" Inherits="PDlist" enableEventValidation="false" %>
		    ...
		    <div id="page-wrapper">
			    ...
			    <!-- Main -->
				    <div class="wrapper">
						    ...
						    <div class="row">
							    <div class="4u 12u(narrower)">
                                    ...
                                    <div class="8u 12u(narrower) important(narrower)">
                                        <article id="content">
                                            <asp:Panel ID="Panel_PDlist" runat="server" >
                                                <header>
									                <h2>新品上市</h2>
										            <p>全館滿899免運費</p>
									            </header>
                                                 <asp:DataList ID="DataList1" runat="server" DataKeyField="PD_ID" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal">
                                                 <ItemTemplate>
                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='<%# "~/images/" & Eval("PD_Photo") & ".jpg" %>' Height="208px" Width="160px" CommandName="Select" OnClick="ImageButton1_Click" />
                                                    <br>
                                                    <asp:Label ID="PD_NameLabel" runat="server" Text='<%# Eval("PD_Name") %>' />
                                                    &nbsp;
                                                    <asp:Label ID="PD_PriceLabel" runat="server" Text='<%# "$" & Eval("PD_Price") %>' />
                                                 </ItemTemplate>
                                                 </asp:DataList>
                                             </asp:Panel>
                                        </article>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SampleShopConnectionString %>" SelectCommand="SELECT * FROM [Products]" DeleteCommand="DELETE FROM [Products] WHERE [PD_ID] = @PD_ID" InsertCommand="INSERT INTO [Products] ([PD_Name], [PD_Price], [PD_Quantity], [PD_Photo], [PD_Desc]) VALUES (@PD_Name, @PD_Price, @PD_Quantity, @PD_Photo, @PD_Desc)" UpdateCommand="UPDATE [Products] SET [PD_Name] = @PD_Name, [PD_Price] = @PD_Price, [PD_Quantity] = @PD_Quantity, [PD_Photo] = @PD_Photo, [PD_Desc] = @PD_Desc WHERE [PD_ID] = @PD_ID">
                            <DeleteParameters>
