...
y1 = pnorm((beta0+beta1*x1+beta2*x2))
y1
x1 = 0.3
beta0+beta1*x1+beta2*x2
y2 = pnorm((beta0+beta1*x1+beta2*x2))
x1 = 0.5
beta0+beta1*x1+beta2*x2
y3 = pnorm((beta0+beta1*x1+beta2*x2))
y3 
y1-y3
y1-y2
...
x1 = 0.1
beta0+beta1*x1+beta2*x2
y4 = pnorm((beta0+beta1*x1+beta2*x2))
y4
x1 = 0.2
beta0+beta1*x1+beta2*x2
y5 = pnorm((beta0+beta1*x1+beta2*x2))
y5
y4-y5
