...
windows()
par(mfrow=c(2,2))
hist(turo, breaks=100, prob=T, main="(a) TSMC月平均週轉率分配 n=10",lwd=2)
abline(v=mean(tu), col="red",lwd=2)
...
hist(turo, breaks=100, prob=T, main=" (b) TSMC月平均週轉率分配 n=30",lwd=2)
abline(v=mean(tu), col="red",lwd=2)
lines(density(turo), lty=2, col="blue",lwd=2)
points(mean(turo),0, lwd=3)
mean(turo)-mean(tu)
...
hist(turo, breaks=100, prob=T, main=" (c) TSMC月平均週轉率分配 n=100",lwd=2)
abline(v=mean(tu), col="red",lwd=2)
lines(density(turo), lty=2, col="blue",lwd=2)
points(mean(turo),0, lwd=3)
mean(turo)-mean(tu)
...
hist(turo, breaks=100, prob=T, main=" (d) TSMC月平均週轉率分配 n=1000",lwd=2)
abline(v=mean(tu), col="red",lwd=2)
lines(density(turo), lty=2, col="blue",lwd=2)
points(mean(turo),0, lwd=3)
mean(turo)-mean(tu)
...
legend("topright",c("平均數","中位數","眾數"), lty=c(2,3,4),lwd=2,
